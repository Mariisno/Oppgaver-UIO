public class Celle {
    ...
    public boolean levende = false; //Cellen er død
    public Celle naboer[] = new Celle[8]; //variabel for naboer -> plass til 8 Celler
    public int antNaboer = 0; //angir nåværende antall naboer -> initieres til 0
    public int antLevendeNaboer = 0; // Sjekker hvor mange som er levende -> starter også på 0
